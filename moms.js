...
var main = function () {
    ...
    $('#jody').click(function () {
        $('.audio').attr("src", "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/344942624&amp;color=%2300cc11&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false");
        ...
        $('#img1').attr("src", "/Jody Springer final photos/Jody1.JPG");
        $('#img2').attr("src", "/Jody Springer final photos/Jody2.JPG");
        $('#img3').attr("src", "/Jody Springer final photos/Jody3.JPG");
        $('#img4').attr("src", "/Jody Springer final photos/Jody4.JPG");
        $('#img5').attr("src", "/Jody Springer final photos/Jody5.JPG");
        $('#img6').attr("src", "/Jody Springer final photos/Jody6.JPG");

    });
    
    $('#micki').click(function () {
        $('.audio').attr("src", "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/344942371&amp;color=%23ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false");
    ...
    $('#darlene').click(function () {
        $('.audio').attr("src", "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/344941654&amp;color=%23ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false");
